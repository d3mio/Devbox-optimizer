"""
DevBox Optimizer Studio — Visual Environment GUI
...
class ApplicationGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("DevBox Optimizer Studio — Visual Environment GUI")
        ...
        title_label = ttk.Label(header_frame, text="⚡ DevBox Optimizer Studio — Visual Environment GUI", style="Header.TLabel")
        title_label.pack(anchor="w")
        
        sub_label = ttk.Label(header_frame, text="Desktop GUI application that detects dev environment inconsistencies, clears docker caches, and optimizes toolchains.", foreground="#94A3B8")
